namespace KDTVN_Shared.Helper
{
    public class DBConnection
    {
        ...
        //public const string KDTVN_PART_MANUFACTURING_MGMT = @"Data Source=KDTVN-PC1035\SQLEXPRESS;Initial Catalog=KDTVN_PART_MANUFACTURING_MGMT;Integrated Security=True;TrustServerCertificate=true";
        public const string KDTVN_PART_MANUFACTURING_MGMT = @"Data Source=KDTVN-PC1035;Initial Catalog=KDTVN_PART_MANUFACTURING_MGMT;Integrated Security=True;TrustServerCertificate=true";
